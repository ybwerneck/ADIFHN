...
double calcularFXs(double **U,double g,int x,int y )
...
char gnuplotparam[80];
    ...
    case 1:
        ...
        break;
    case 2:
        sprintf(gnuplotparam,"gnuplot  -e dt=%f -e dx=%f -p  \"script2.txt\" %f",dt,dx);
        break;
    case 3:
        sprintf(gnuplotparam,"gnuplot  -e dt=%f -e dx=%f -p  \"script3.txt\" %f",dt,dx);
        break;
    }
